...
public class CrossBow : Weapon
{
    ...
    private CrossBow(string name, string? description, double weight, int level, int usageLimit,
        double damageConst,  double reloadConst, double actionRadiusConst, int arrowsCount, double penetration)
    {
        this.Name = name;
    ...
    public class Builder
    {
        ...
        public Builder SetPenetration(double penetration)
        {
        ...
        {
            return new CrossBow(_name, _description, _weight, _level, _usageLimit,  _damageConst, _reloadConst, _actionRadiusConst, _arrowsCount, _penetration);
        }
    }
